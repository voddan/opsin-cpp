...
void CASToolsTest::cas4() throw(ParsingException) {
    std::wstring name = CASTools::uninvertCASName(
            L"Phosphonic acid, P,P'-(8-methylene-3,7,10,14-tetraoxo-4,6,11,13-tetraazahexadecane-1,16-diyl)-bis-, P,P,P',P'-tetramethyl ester",
            parseRules);
    assertEquals(
            L"P,P,P',P'-tetramethyl P,P'-(8-methylene-3,7,10,14-tetraoxo-4,6,11,13-tetraazahexadecane-1,16-diyl)-bis-Phosphonate",
            name);
}
...
void CASToolsTest::cas5() throw(ParsingException) {
    std::wstring name = CASTools::uninvertCASName(L"Benzenamine, 3,3',3''-(1-ethenyl-2-ylidene)tris[6-methyl-",
                                                  parseRules);
...
void CASToolsTest::cas7() throw(ParsingException) {
    std::wstring name = CASTools::uninvertCASName(L"1-Butanesulfonic acid, 2,4-diamino-3-chloro- 1-ethyl ester",
                                                  parseRules);
...
void CASToolsTest::cas8() throw(ParsingException) {
    std::wstring name = CASTools::uninvertCASName(
            L"Benzenecarboximidamide, N'-(1E)-1-propen-1-yl-N-(1Z)-1-propen-1-yl-", parseRules);
...
void CASToolsTest::cas17() throw(ParsingException) {
    std::wstring name = CASTools::uninvertCASName(L"piperazinium, 1,1-dimethyl-, 2,2,2-trifluoroacetate hydrochloride",
                                                  parseRules);
...
void CASToolsTest::cas21() throw(ParsingException) {
    std::wstring name = CASTools::uninvertCASName(L"Acetic acid, 2-amino-2-oxo-, 2-(phenylmethylene)hydrazide",
                                                  parseRules);
...
void CASToolsTest::cas24() throw(ParsingException) {
    std::wstring name = CASTools::uninvertCASName(
            L"Pyrrolo[1,2-a]pyrimidinium, 1-[4-[(aminoiminomethyl)amino]butyl]-7-[[2-[(aminoiminomethyl)-amino]ethyl]thio]-6-(11-dodecenyl)-2,3,4,6,7,8-hexahydro-6-hydroxy-, chloride, dihydrochloride",
            parseRules);
    assertEquals(
            L"1-[4-[(aminoiminomethyl)amino]butyl]-7-[[2-[(aminoiminomethyl)-amino]ethyl]thio]-6-(11-dodecenyl)-2,3,4,6,7,8-hexahydro-6-hydroxy-Pyrrolo[1,2-a]pyrimidinium chloride dihydrochloride",
            name);
}
...
void CASToolsTest::notCas2() throw(ParsingException) {
    CASTools::uninvertCASName(
            L"cyclopropane-1,2-diyldicarbonyl diisocyanate, cyclopropane-1,2-diylbis(carbonyl)bisisocyanate",
            parseRules);
}
