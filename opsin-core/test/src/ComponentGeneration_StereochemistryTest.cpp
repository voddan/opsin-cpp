...
void ComponentGeneration_StereochemistryTest::testBracketedLocantedCisTrans() throw(ComponentGenerationException) {
    ...
    assertEquals(XmlDeclarations::CISORTRANS_TYPE_VAL,
                 newStereochemistryEl1->getAttributeValue(XmlDeclarations::TYPE_ATR));
    ...
    assertEquals(XmlDeclarations::CISORTRANS_TYPE_VAL,
                 newStereochemistryEl2->getAttributeValue(XmlDeclarations::TYPE_ATR));
}
...
void ComponentGeneration_StereochemistryTest::testBracketedExo() throw(ComponentGenerationException) {
    ...
    assertEquals(XmlDeclarations::ENDO_EXO_SYN_ANTI_TYPE_VAL,
                 newStereochemistryEl->getAttributeValue(XmlDeclarations::TYPE_ATR));
}
...
void ComponentGeneration_StereochemistryTest::testLocantedCisTrans() throw(ComponentGenerationException) {
    ...
    assertEquals(XmlDeclarations::CISORTRANS_TYPE_VAL,
                 modifiedStereochemistryEl1->getAttributeValue(XmlDeclarations::TYPE_ATR));
    ...
    assertEquals(XmlDeclarations::CISORTRANS_TYPE_VAL,
                 modifiedStereochemistryEl2->getAttributeValue(XmlDeclarations::TYPE_ATR));
}
...
void ComponentGeneration_StereochemistryTest::testLocantedExoOn() throw(ComponentGenerationException) {
    ...
    assertEquals(XmlDeclarations::ENDO_EXO_SYN_ANTI_TYPE_VAL,
                 modifiedStereochemistryEl->getAttributeValue(XmlDeclarations::TYPE_ATR));
}
...
void ComponentGeneration_StereochemistryTest::testAnti() throw(ComponentGenerationException) {
    ...
    assertEquals(XmlDeclarations::ENDO_EXO_SYN_ANTI_TYPE_VAL,
                 unmodifiedStereochemistryEl->getAttributeValue(XmlDeclarations::TYPE_ATR));
}
...
void
ComponentGeneration_StereochemistryTest::testZUnbracketted() throw(ComponentGenerationException) { //note that IUPAC mandates brackets
    //XML for Z,Z:
    Element *substituent = new GroupingEl(XmlDeclarations::SUBSTITUENT_EL);
    ...
    assertEquals(XmlDeclarations::E_OR_Z_TYPE_VAL,
                 modifiedStereochemistryEl1->getAttributeValue(XmlDeclarations::TYPE_ATR));
...
void
ComponentGeneration_StereochemistryTest::testEandZUnbrackettedLocanted() throw(ComponentGenerationException) { //note that IUPAC mandates brackets
    //XML for 2E,4Z:
    Element *substituent = new GroupingEl(XmlDeclarations::SUBSTITUENT_EL);
...
void
ComponentGeneration_StereochemistryTest::testEandZUnbrackettedBeforeEne() throw(ComponentGenerationException) { //not allowed in IUPAC names
    //XML for 2E,4Z-diene:
    Element *substituent = new GroupingEl(XmlDeclarations::SUBSTITUENT_EL);
    Element *locant = new TokenEl(XmlDeclarations::LOCANT_EL, L"2");
    substituent->addChild(locant);
...
void
ComponentGeneration_StereochemistryTest::testEandZUnbrackettedBeforeYlidene() throw(ComponentGenerationException) { //not allowed in IUPAC names
    //XML for 2Z-ylidene:
    Element *substituent = new GroupingEl(XmlDeclarations::SUBSTITUENT_EL);
    Element *locant = new TokenEl(XmlDeclarations::LOCANT_EL, L"2");
    substituent->addChild(locant);
...
void ComponentGeneration_StereochemistryTest::testBrackettedAlphaBeta() throw(ComponentGenerationException) {
    ...
    assertEquals(XmlDeclarations::ALPHA_OR_BETA_TYPE_VAL,
                 newStereochemistryEl->getAttributeValue(XmlDeclarations::TYPE_ATR));
...
void
ComponentGeneration_StereochemistryTest::testAlphaBetaNotDirectlyPrecedingANaturalProduct1() throw(ComponentGenerationException) {
    Element *substituent = new GroupingEl(XmlDeclarations::SUBSTITUENT_EL);
    Element *stereochem = new TokenEl(XmlDeclarations::STEREOCHEMISTRY_EL, L"3beta,5alpha");
    Attribute tempVar(XmlDeclarations::TYPE_ATR, XmlDeclarations::ALPHA_OR_BETA_TYPE_VAL);
    stereochem->addAttribute(&tempVar);
...
void
ComponentGeneration_StereochemistryTest::testAlphaBetaNotDirectlyPrecedingANaturalProduct2() throw(ComponentGenerationException) {
    Element *substituent = new GroupingEl(XmlDeclarations::SUBSTITUENT_EL);
    Element *stereochem = new TokenEl(XmlDeclarations::STEREOCHEMISTRY_EL, L"(3beta,5alpha)");
    Attribute tempVar(XmlDeclarations::TYPE_ATR, XmlDeclarations::STEREOCHEMISTRYBRACKET_TYPE_VAL);
    stereochem->addAttribute(&tempVar);
...
void
ComponentGeneration_StereochemistryTest::testAlphaBetaNotDirectlyPrecedingANaturalProduct3() throw(ComponentGenerationException) {
    Element *substituent = new GroupingEl(XmlDeclarations::SUBSTITUENT_EL);
    Element *naturalProduct = new TokenEl(XmlDeclarations::GROUP_EL);
...
void
ComponentGeneration_StereochemistryTest::testAlphaBetaStereoMixedWithNormalLocants() throw(ComponentGenerationException) {
    Element *substituent = new GroupingEl(XmlDeclarations::SUBSTITUENT_EL);
...
void ComponentGeneration_StereochemistryTest::testRelativeCisTrans() throw(ComponentGenerationException) {
    ...
    assertEquals(XmlDeclarations::RELATIVECISTRANS_TYPE_VAL,
                 modifiedStereochemistryEl1->getAttributeValue(XmlDeclarations::TYPE_ATR));
...
void ComponentGeneration_StereochemistryTest::processStereochemistry(
        Element *subOrRoot) throw(ComponentGenerationException) {
