...
private:
    static Logger *const LOG = Logger::getLogger(AutomatonInitialiser::
    typeid);
...
public:
    ...
    virtual RunAutomaton *
    loadAutomaton(const std::wstring &automatonName, const std::wstring &regex, bool tableize, bool reverseAutomaton);
