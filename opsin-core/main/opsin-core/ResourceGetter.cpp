...
ResourceGetter::ResourceGetter(const std::wstring &resourcePath) : resourcePath(resourcePath.substr(1)),
                                                                   workingDirectory((&tempVar)->getCanonicalPath())
...
{
if (
boost::starts_with(resourcePath,
L"/"))
{
}
this->
