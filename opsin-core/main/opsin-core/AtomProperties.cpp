...
const std::unordered_map<ChemEl, double> AtomProperties::elementToPaulingElectronegativity = new java::util::EnumMap<ChemEl, double>(
        ChemEl::
typeid);
const std::unordered_map<ChemEl, int> AtomProperties::elementToHwPriority = new java::util::EnumMap<ChemEl, int>(
        ChemEl::
typeid);
