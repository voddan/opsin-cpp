			...
			namespace ch
			{
				namespace wwmm
				{
					namespace opsin
					{
						...
						public:
							static IsotopeSpecification *parseIsotopeSpecification(Element *isotopeSpecification) throw(StructureBuildingException);

						private:
							static IsotopeSpecification *processBoughtonIsotope(Element *isotopeSpecification) throw(StructureBuildingException);
