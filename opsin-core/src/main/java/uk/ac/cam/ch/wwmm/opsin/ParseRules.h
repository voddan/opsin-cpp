...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class OpsinRadixTrie; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class AnnotatorState; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class ResourceManager; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class ParseRulesResults; } } } } } }
			...
			namespace ch
			{
				namespace wwmm
				{
					namespace opsin
					{
						...
						private:
							ParseTokens *convertAnnotationStateToParseTokens(AnnotatorState *as, const std::wstring &chemicalWord, const std::wstring &chemicalWordLowerCase);
						};
