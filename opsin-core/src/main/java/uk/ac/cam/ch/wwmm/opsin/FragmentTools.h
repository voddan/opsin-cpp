...
//						import static uk.ac.cam.ch.wwmm.opsin.XmlDeclarations.*;
						...
						public:
							static void assignElementLocants(Fragment *suffixableFragment, std::vector<Fragment*> &suffixFragments) throw(StructureBuildingException);

						private:
							static void detectAndCorrectHydrazoneDerivativeViolation(std::vector<Fragment*> &suffixFragments);

							static void processMainGroupLabelling(Fragment *suffixableFragment, std::unordered_map<std::wstring, int> &elementCount, Set<Atom*> *atomsToIgnore);

							static void processSuffixLabelling(std::vector<Fragment*> &suffixFragments, std::unordered_map<std::wstring, int> &elementCount, Set<Atom*> *atomsToIgnore);

							static void processNonCarboxylicAcidLabelling(Fragment *suffixableFragment, std::unordered_map<std::wstring, int> &elementCount, Set<Atom*> *atomsToIgnore);

							static void assignLocantsAndExploreNeighbours(std::unordered_map<std::wstring, int> &elementCount, Set<Atom*> *atomsToIgnore, Set<Atom*> *atomsVisited, Deque<Atom*> *atomsToConsider);
						...
						public:
							...
							/// <param name="fragment"> The fragment </param>
							/// <exception cref="StructureBuildingException"> </exception>
							static void unsaturate(Atom *fromAtom, const std::wstring &locantTo, int bondOrder, Fragment *fragment) throw(StructureBuildingException);
						...
						public:
							static Atom *getAtomByAminoAcidStyleLocant(Atom *backboneAtom, const std::wstring &elementSymbol, const std::wstring &primes);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							static void removeTerminalOxygen(BuildState *state, Atom *atom, int desiredBondOrder) throw(StructureBuildingException);
							...
							static std::vector<Atom*> findnAtomsForSubstitution(std::vector<Atom*> &atomList, Atom *preferredAtom, int numberOfSubstitutionsRequired, int bondOrder, bool takeIntoAccountOutValency);

							static std::vector<Atom*> findnAtomsForSubstitution(Fragment *frag, Atom *preferredAtom, int numberOfSubstitutionsRequired, int bondOrder, bool takeIntoAccountOutValency);
							...
							/// @return </param>
							static std::vector<Atom*> findnAtomsForSubstitution(Fragment *frag, int numberOfSubstitutionsRequired, int bondOrder);
