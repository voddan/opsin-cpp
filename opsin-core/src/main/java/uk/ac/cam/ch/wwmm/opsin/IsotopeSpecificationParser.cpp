			...
			namespace ch
			{
				namespace wwmm
				{
					namespace opsin
					{
						...
						IsotopeSpecificationParser::IsotopeSpecification::IsotopeSpecification(ChemEl chemEl, int isotope, int multiplier, std::vector<std::wstring> &locants) : chemEl(chemEl), isotope(isotope), multiplier(multiplier), locants(locants)
						{
						}
						...
						IsotopeSpecificationParser::IsotopeSpecification *IsotopeSpecificationParser::parseIsotopeSpecification(Element *isotopeSpecification) throw(StructureBuildingException)
						{
...
//ORIGINAL LINE: throw new RuntimeException("Unsupported isotope specification syntax");
						...
						IsotopeSpecificationParser::IsotopeSpecification *IsotopeSpecificationParser::processBoughtonIsotope(Element *isotopeSpecification) throw(StructureBuildingException)
						{
...
//JAVA TO C++ CONVERTER TODO TASK: There is no direct native C++ equivalent to the Java String 'split' method:
								...
								{
									throw StructureBuildingException(std::wstring(L"Mismatch between number of locants: ") + locants.size() + std::wstring(L" and number of hydrogen isotopes requested: ") + std::to_wstring(multiplier));
								}
							}
							return new IsotopeSpecification(chemEl, isotope, multiplier, locants);
						}

						IsotopeSpecificationParser::IsotopeSpecification *IsotopeSpecificationParser::processIupacIsotope(Element *isotopeSpecification) throw(StructureBuildingException)
						{
							std::wstring val = isotopeSpecification->getValue();
...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
									throw StructureBuildingException(std::wstring(L"Mismatch between number of locants: ") + locants.size() + std::wstring(L" and number of ") + chemEl::toString() + std::wstring(L" isotopes requested: ") + std::to_wstring(multiplier));
								}
							}
							return new IsotopeSpecification(chemEl, isotope, multiplier, locants);
						}
