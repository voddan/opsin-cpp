...
//						import static uk.ac.cam.ch.wwmm.opsin.StructureBuildingMethods.*;
						...
						private:
							...
							/// <exception cref="StructureBuildingException">  </exception>
							void formAppropriateBondToOxideAndAdjustCharges(Atom *atomToAddOxideTo, Atom *oxideAtom) throw(StructureBuildingException);

							void buildCarbonylDerivative(std::vector<Element*> &words) throw(StructureBuildingException);

							void replaceCarbonylOxygenWithReplacementFragments(std::vector<Element*> &words, std::vector<Fragment*> &replacementFragments, std::vector<Atom*> &carbonylOxygens, int functionalReplacementsToPerform) throw(StructureBuildingException);
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							std::vector<Atom*> findCarbonylOxygens(Fragment *fragment, std::vector<std::wstring> &locantForCarbonylAtom) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							void formAnhydrideLink(const std::wstring &anhydrideSmiles, BuildResults *acidBr1, BuildResults *acidBr2) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							void formAnhydrideLink(const std::wstring &anhydrideSmiles, Atom *oxygen1, Atom *oxygen2) throw(StructureBuildingException);
							...
							void applyAluminiumHydrideSpecialCase(Element *firstWord, Atom *elementaryAtom, std::vector<Fragment*> &functionalGroupFragments) throw(StructureBuildingException);
							...
							void replaceChalcogensInAcetal(Element *functionalClassEl, std::vector<std::wstring> &elements) throw(StructureBuildingException);

							Fragment *formAcetal(std::vector<Atom*> &carbonylOxygen, std::vector<std::wstring> &elements) throw(StructureBuildingException);
							...
							static Pattern *const matchCommonCarboxylicSalt = Pattern::compile(L"tri-?fluoro-?acetate?$", Pattern::CASE_INSENSITIVE);
							static Pattern *const matchCommonEsterFormingInorganicSalt = Pattern::compile(L"(ortho-?)?(bor|phosphor|phosphate?|phosphite?)|carbam|carbon|sulfur|sulfate?|sulfite?|diphosphate?|triphosphate?", Pattern::CASE_INSENSITIVE);
							...
							void connectSubstituentsToAcetal(std::vector<Fragment*> &acetalFrags, BuildResults *subBr, bool hemiacetal) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							Atom *determineFunctionalAtomToUse(const std::wstring &locant, BuildResults *mainGroupBR) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							void manipulateStoichiometry(Element *molecule, std::vector<Element*> &wordRules) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							void balanceChargeIfPossible(Element *molecule, int overallCharge, bool explicitStoichiometryPresent) throw(StructureBuildingException);
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							bool multiplyChargedComponents(std::vector<Element*> &negativelyChargedComponents, std::vector<Element*> &positivelyChargedComponents, std::unordered_map<Element*, int> &componentToChargeMapping, int overallCharge) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							Atom *getOutAtomTakingIntoAccountWhetherSetExplicitly(BuildResults *buildResults, int i) throw(StructureBuildingException);
						};
