...
//						import static uk.ac.cam.ch.wwmm.opsin.XmlDeclarations.*;
						...
						public:
							...
							virtual void processAcidReplacingFunctionalClassNomenclature(Element *finalSubOrRootInWord, Element *word) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							/// <exception cref="ComponentGenerationException">  </exception>
							virtual bool processPrefixFunctionalReplacementNomenclature(std::vector<Element*> &groups, std::vector<Element*> &substituents) throw(StructureBuildingException, ComponentGenerationException);
						...
						private:
							...
							/// <exception cref="ComponentGenerationException"> </exception>
						public:
							virtual void processInfixFunctionalReplacementNomenclature(std::vector<Element*> &suffixes, std::vector<Fragment*> &suffixFragments) throw(StructureBuildingException, ComponentGenerationException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
						private:
							void processAcidReplacingFunctionalClassNomenclatureFullWord(Element *acidContainingRoot, Element *acidReplacingWord) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException"> </exception>
							void processAcidReplacingFunctionalClassNomenclatureFunctionalWord(Element *acidContainingRoot, Element *functionalWord) throw(ComponentGenerationException, StructureBuildingException);

							Atom *removeOxygenWithAppropriateLocant(std::vector<Atom*> &oxygenAtoms, const std::wstring &locant) throw(ComponentGenerationException);
							...
							bool acidHasSufficientHydrogenForSubstitutionInterpretation(Fragment *acidFrag, int hydrogenRequiredForSubstitutionInterpretation, Element *locantEl);
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							int performChalcogenFunctionalReplacement(Element *groupToBeModified, Element *locantEl, int numberOfAtomsToReplace, const std::wstring &replacementSmiles) throw(StructureBuildingException);
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							int performPeroxyFunctionalReplacement(Element *groupToBeModified, Element *locantEl, int numberOfAtomsToReplace) throw(StructureBuildingException);
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							int performFunctionalReplacementOnAcid(Element *groupToBeModified, Element *locantEl, int numberOfAtomsToReplace, const std::wstring &replacementSmiles) throw(StructureBuildingException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException"> </exception>
							void disambiguateMultipliedInfixMeaning(std::vector<Element*> &suffixes, std::vector<Fragment*> &suffixFragments, Element *suffix, std::vector<std::wstring> &infixTransformations, int oxygenAvailable) throw(ComponentGenerationException, StructureBuildingException);
							...
							void populateTerminalSingleAndDoubleBondedOxygen(std::vector<Atom*> &atomList, std::vector<Atom*> &singleBondedOxygen, std::vector<Atom*> &doubleBondedOxygen) throw(StructureBuildingException);
						};
