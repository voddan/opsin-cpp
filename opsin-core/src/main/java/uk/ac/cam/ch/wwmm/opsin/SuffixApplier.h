...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class SuffixRules; } } } } } }
...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class SuffixRule; } } } } } }
...
//						import static uk.ac.cam.ch.wwmm.opsin.XmlDeclarations.*;
						...
						public:
							...
							virtual void resolveSuffixes(Element *group, std::vector<Element*> &suffixes) throw(StructureBuildingException, ComponentGenerationException);

						private:
							void applyIsotopeToSuffix(Fragment *frag, Element *isotopeSpecification, bool mustBeApplied) throw(StructureBuildingException);
							...
							void processCycleFormingSuffix(Fragment *suffixFrag, Fragment *suffixableFragment, Element *suffix) throw(StructureBuildingException, ComponentGenerationException);

							Atom *getFragAtomToUse(Fragment *frag, Element *suffix, const std::wstring &suffixTypeToUse) throw(StructureBuildingException);
						...
						public:
							virtual std::vector<SuffixRule*> getSuffixRuleTags(const std::wstring &suffixTypeToUse, const std::wstring &suffixValue, const std::wstring &subgroupType) throw(ComponentGenerationException);
						};
