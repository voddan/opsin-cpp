...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class ApplicableSuffix; } } } } } }
...
//						import static uk.ac.cam.ch.wwmm.opsin.XmlDeclarations.*;
						...
						private:
							std::unordered_map<std::wstring, std::vector<SuffixRule*>> generateSuffixRulesMap(ResourceGetter *resourceGetter) throw(IOException);


							std::vector<SuffixRule*> processSuffixRules(XMLStreamReader *reader) throw(XMLStreamException);

							std::unordered_map<std::wstring, std::unordered_map<std::wstring, std::vector<ApplicableSuffix*>>> generateSuffixApplicabilityMap(ResourceGetter *resourceGetter, std::unordered_map<std::wstring, std::vector<SuffixRule*>> &suffixRulesMap) throw(IOException);
