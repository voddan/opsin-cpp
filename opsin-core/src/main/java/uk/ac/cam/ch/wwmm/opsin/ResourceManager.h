...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class TokenEl; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class ResourceGetter; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class AutomatonInitialiser; } } } } } }
...
//JAVA TO C++ CONVERTER WARNING: The following method was originally marked 'synchronized':
							...
							virtual TokenEl *makeTokenElement(const std::wstring &tokenString, boost::optional<wchar_t> symbol) throw(ParsingException);
