			...
			namespace ch
			{
				namespace wwmm
				{
					namespace opsin
					{
						...
						IndentingXMLStreamWriter::IndentingXMLStreamWriter(XMLStreamWriter *writer, int indentSize) : org::codehaus::stax2::util::StreamWriterDelegate(writer), indentSize(indentSize)
						{
						}
