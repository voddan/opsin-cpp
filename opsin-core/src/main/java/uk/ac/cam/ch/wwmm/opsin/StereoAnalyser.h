...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class AtomNeighbouringColoursComparator; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class AtomicNumberThenAtomicMassComparator; } } } } } }
				...
				namespace wwmm
				{
					namespace opsin
					{
						...
						private:
							...
							AtomNeighbouringColoursComparator *const atomNeighbouringColoursComparator = new AtomNeighbouringColoursComparator(this);
						...
						private:
							...
							bool populateColoursAndReportIfColoursWereChanged(std::vector<std::vector<Atom*>> &groupsByColour, std::vector<std::vector<Atom*>> &updatedGroupsByColour);
						...
						private:
							...
							std::vector<Atom*> findParaStereoCentres(std::vector<Atom*> &potentialStereoAtoms, std::vector<Atom*> &trueStereoCentres);


							bool branchesHaveTrueStereocentre(Atom *branchAtom1, Atom *branchAtom2, Atom *potentialStereoAtom, std::vector<Atom*> &trueStereoCentres);
