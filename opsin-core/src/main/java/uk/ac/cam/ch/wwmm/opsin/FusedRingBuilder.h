...
//						import static uk.ac.cam.ch.wwmm.opsin.XmlDeclarations.*;
						...
						private:
							...
							int processMultiParentSystem(std::vector<Fragment*> &parentFragments, std::vector<Element*> &nameComponents, std::vector<Fragment*> &componentFragments) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							void performSimpleFusion(const std::wstring &fusionDescriptor, Fragment *childRing, Fragment *parentRing) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							void processFirstOrderFusionDescriptors(Fragment *childRing, Fragment *parentRing, std::vector<std::wstring> &numericalLocantsOfChild, std::vector<std::wstring> &letterLocantsOfParent) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException">  </exception>
							void performHigherOrderFusion(const std::wstring &fusionDescriptor, Fragment *nextComponent, Fragment *fusedRing) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							void processHigherOrderFusionDescriptors(Fragment *childRing, Fragment *parentRing, std::vector<std::wstring> &numericalLocantsOfChild, std::vector<std::wstring> &numericalLocantsOfParent) throw(StructureBuildingException);
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							std::vector<Atom*> determineAtomsToFuse(Fragment *ring, std::vector<std::wstring> &numericalLocantsOnRing, boost::optional<int> expectedNumberOfAtomsToBeUsedForFusion) throw(StructureBuildingException);
