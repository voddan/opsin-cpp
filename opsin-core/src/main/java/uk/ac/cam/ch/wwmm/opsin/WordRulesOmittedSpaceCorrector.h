...
//						import static uk.ac.cam.ch.wwmm.opsin.StructureBuildingMethods.findRightMostGroupInSubBracketOrRoot;
						...
						private:
							...
							bool insufficientSubstitutableHydrogenForSubstitution(std::vector<Element*> &substituentsAndBrackets, Fragment *frag, int rootMultiplier);
							...
							/// @return </param>
							bool specialCaseWhereEsterPreferred(Element *substituentGroupEl, const std::wstring &multiplierValue, Element *rootGroup, int numOfSubstituents);
							...
							void transformToEster(Element *parentSimpleWordRule, Element *substituentOrBracket) throw(StructureBuildingException);
						};
