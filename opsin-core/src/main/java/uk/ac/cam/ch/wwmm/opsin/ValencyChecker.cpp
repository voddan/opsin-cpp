...
const std::unordered_map<ChemEl, int> ValencyChecker::expectedDefaultValency = new java::util::EnumMap<ChemEl, int>(ChemEl::typeid);
const std::unordered_map<ChemEl, int> ValencyChecker::valencyInHW = new java::util::EnumMap<ChemEl, int>(ChemEl::typeid);
const std::unordered_map<ChemEl, std::unordered_map<int, std::vector<Integer>>> ValencyChecker::possibleStableValencies = new java::util::EnumMap<ChemEl, std::unordered_map<int, std::vector<Integer>>>(ChemEl::typeid);
