...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class StereoCentre; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class Bond; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class StereoBond; } } } } } }
...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class StereochemistryException; } } } } } }
...
//						import static uk.ac.cam.ch.wwmm.opsin.XmlDeclarations.*;
						...
						public:
							...
							StereochemistryHandler(BuildState *state, std::unordered_map<Atom*, StereoCentre*> &atomStereoCentreMap, std::unordered_map<Bond*, StereoBond*> &bondStereoBondMap);
							...
							virtual void applyStereochemicalElements(std::vector<Element*> &stereoChemistryEls) throw(StructureBuildingException);
							...
							virtual void removeRedundantStereoCentres(std::vector<Atom*> &atomsWithPreDefinedAtomParity, std::vector<Bond*> &bondsWithPreDefinedBondStereo);
						...
						private:
							void matchStereochemistryToAtomsAndBonds(Element *stereoChemistryEl) throw(StructureBuildingException, StereochemistryException);
							...
							/// <exception cref="StructureBuildingException">  </exception>
							void processCarbohydrateStereochemistry(std::vector<Element*> &carbohydrateStereoChemistryEls) throw(StructureBuildingException);
							...
							bool attemptAssignmentOfStereoCentreToFragment(Fragment *fragment, const std::wstring &rOrS, const std::wstring &locant) throw(StereochemistryException, StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							/// <exception cref="StereochemistryException"> </exception>
							void applyStereoChemistryToStereoCentre(Atom *atom, StereoCentre *stereoCentre, const std::wstring &rOrS) throw(StructureBuildingException, StereochemistryException);
							...
							bool attemptAssignmentOfStereoBondToFragment(Fragment *fragment, const std::wstring &eOrZ, const std::wstring &locant, bool isCisTrans) throw(StereochemistryException);
						...
						private:
							...
							/// <exception cref="StereochemistryException">  </exception>
							void applyStereoChemistryToStereoBond(Bond *bond, StereoBond *stereoBond, const std::wstring &eOrZ) throw(StereochemistryException);
							...
							bool attemptAssignmentOfCisTransRingStereoToFragment(Fragment *fragment, Element *stereoChemistryEl) throw(StructureBuildingException);

							Set<Bond*> *determinePeripheryBonds(Fragment *fragment);

							void applyStereoChemistryToCisTransOnRing(Atom *a1, Atom *a2, std::vector<std::vector<Atom*>> &paths, std::vector<Atom*> &fragmentAtoms, const std::wstring &cisOrTrans) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							void applyAlphaBetaStereochemistryToStereoCentre(Atom *stereoAtom, Fragment *fragment, const std::wstring &alphaBetaClockWiseAtomOrdering, const std::wstring &alphaOrBeta, Fragment *substituentGroup) throw(StructureBuildingException);
							...
							/// <param name="carbohydrateStereoChemistryEls"> </param>
							/// <exception cref="StructureBuildingException">  </exception>
							void assignCarbohydratePrefixStereochem(Element *carbohydrateGroup, std::vector<Element*> &carbohydrateStereoChemistryEls) throw(StructureBuildingException);

							void assignDlStereochem(Element *stereoChemistryEl) throw(StructureBuildingException);


							bool attemptAssignmentOfDlStereoToFragment(Fragment *fragment, const std::wstring &dOrL) throw(StereochemistryException, StructureBuildingException);

						public:
							static int swapsRequiredToSort(std::vector<Atom*> &atomRefs4);

							static bool checkEquivalencyOfAtomsRefs4AndParity(std::vector<Atom*> &atomRefs1, int atomParity1, std::vector<Atom*> &atomRefs2, int atomParity2);
						};
