...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class RingShape; } } } } } }
			...
			namespace ch
			{
				namespace wwmm
				{
					namespace opsin
					{
						...
						private:
							static Logger *const LOG = Logger::getLogger(FusedRingNumberer::typeid);
						private:
						...
						private:
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							static std::vector<std::vector<Atom*>> determinePossiblePeripheryAtomOrders(std::vector<Ring*> &rings, int atomCountOfFusedRingSystem) throw(StructureBuildingException);
							...
							/// <param name="cts">
							/// @return </param>
							static std::vector<RingConnectivityTable*> buildRingConnectionTables(Ring *currentRing, Ring *previousRing, int previousDir, Bond *previousBond, Atom *atom, RingConnectivityTable *ct, std::vector<RingConnectivityTable*> &cts);
							...
							static std::vector<FusionRingShape> removeDegenerateRingShapes(std::vector<FusionRingShape> &allowedRingShapes, std::vector<int> &distances, int ringSize);
							...
							/// <param name="cts">
							/// @return </param>
							static std::unordered_map<RingConnectivityTable*, std::vector<int>> findLongestChainDirections(std::vector<RingConnectivityTable*> &cts);
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							static std::vector<std::vector<std::vector<Ring*>>> createRingMapsAlignedAlongGivenhorizonalRowDirections(std::unordered_map<RingConnectivityTable*, std::vector<int>> &horizonalRowDirectionsMap) throw(StructureBuildingException);
							...
							/// <param name="atomCountOfFusedRingSystem"> 
							/// @return </param>
							static std::vector<std::vector<Atom*>> findPossiblePaths(std::vector<std::vector<std::vector<Ring*>>> &ringMaps, int atomCountOfFusedRingSystem);

							static std::vector<std::vector<Ring*>> generateRingMap(RingConnectivityTable *ct, std::vector<int> &directionFromRingToNeighbouringRing);
							...
							/// <param name="yChain">
							/// @return </param>
							static std::vector<boost::optional<double>> countQuadrants(std::vector<std::vector<Ring*>> &ringMap, int midChainXcoord, int yChain);
							...
							/// <param name="atomCountOfFusedRingSystem"> 
							/// @return </param>
							static std::vector<Atom*> orderAtoms(std::vector<std::vector<Ring*>> &ringMap, bool inverseAtoms, int atomCountOfFusedRingSystem);
							...
							/// @return </param>
							static Ring *findClockwiseRingFromUpperRightRing(std::vector<std::vector<Ring*>> &ringMap, Ring *upperRightRing, std::vector<Ring*> &visitedRings);
							...
							/// @return </param>
							static Ring *findUpperLeftNeighbourOfUpperRightRing(std::vector<std::vector<Ring*>> &ringMap, Ring *upperRightRing);
							...
							/// @return </param>
							static std::vector<std::vector<Ring*>> transformQuadrantToUpperRightOfRingMap(std::vector<std::vector<Ring*>> &ringMap, int upperRightQuadrant);
