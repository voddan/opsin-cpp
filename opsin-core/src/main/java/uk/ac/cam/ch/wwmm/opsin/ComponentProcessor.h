...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class FunctionalReplacement; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class SuffixApplier; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class BuildState; } } } } } }
...
//						import static uk.ac.cam.ch.wwmm.opsin.OpsinTools.*;
						...
						private:
							...
							static Pattern *const matchGroupsThatAreAlsoInlineSuffixes = Pattern::compile(L"carbon|oxy|sulfen|sulfin|sulfon|selenen|selenin|selenon|telluren|tellurin|telluron");
						...
						public:
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							static Fragment *resolveGroup(BuildState *state, Element *group) throw(StructureBuildingException, ComponentGenerationException);
						...
						private:
							...
							/// <exception cref="ComponentGenerationException"> </exception>
						private:
							static void processXyleneLikeNomenclature(BuildState *state, Element *group, Fragment *parentFrag) throw(StructureBuildingException, ComponentGenerationException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							static void setFragmentDefaultInAtomIfSpecified(Fragment *thisFrag, Element *group) throw(StructureBuildingException);
							...
							/// <param name="thisFrag"> </param>
							/// <exception cref="StructureBuildingException"> </exception>
							static void setFragmentFunctionalAtomsIfSpecified(Element *group, Fragment *thisFrag) throw(StructureBuildingException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
						public:
							static bool removeAndMoveToAppropriateGroupIfSubtractivePrefix(Element *substituent) throw(ComponentGenerationException);
						...
						private:
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException"> </exception>
							void determineLocantMeaning(Element *subOrBracketOrRoot, Element *finalSubOrRootInWord) throw(StructureBuildingException, ComponentGenerationException);
							...
							/// <exception cref="ComponentGenerationException">  </exception>
							bool checkSpecialLocantUses(Element *locant, std::vector<std::wstring> &locantValues, Element *finalSubOrRootInWord) throw(ComponentGenerationException);
							...
							/// @return </param>
							bool detectMultiplicativeNomenclature(Element *locant, std::vector<std::wstring> &locantValues, Element *finalSubOrRootInWord);

							void applyDLPrefixes(Element *subOrRoot) throw(ComponentGenerationException);

						public:
							virtual bool applyDlStereochemistryToAminoAcid(Element *aminoAcidEl, const std::wstring &dlStereochemistryValue) throw(ComponentGenerationException);

							virtual void applyDlStereochemistryToCarbohydrate(Element *carbohydrateEl, const std::wstring &dlStereochemistryValue) throw(ComponentGenerationException);

							static void applyDlStereochemistryToCarbohydrateConfigurationalPrefix(Element *elementToApplyTo, const std::wstring &dlStereochemistryValue) throw(ComponentGenerationException);
						...
						private:
							...
							void applyUnspecifiedRingSizeCyclisationIfPresent(Element *group, Atom *potentialCarbonyl) throw(StructureBuildingException);
							...
							/// <returns> </returns>
							/// <exception cref="StructureBuildingException">  </exception>
							Atom *processUloseSuffix(Element *group, Element *suffix, Atom *potentialCarbonyl) throw(StructureBuildingException);
							...
							/// <param name="potentialCarbonyl"> </param>
							/// <exception cref="StructureBuildingException"> </exception>
							void cycliseCarbohydrateAndApplyAlphaBetaStereo(Element *carbohydrateGroup, Element *ringSize, Atom *potentialCarbonyl) throw(StructureBuildingException);

							void applyAlphaBetaStereoToCyclisedCarbohydrate(Element *carbohydrateGroup, Atom *carbonylCarbon);

							void processAldoseDiSuffix(const std::wstring &suffixValue, Element *group, Atom *aldehydeAtom) throw(StructureBuildingException);
							...
							void applyAnomerStereochemistryIfPresent(Element *alphaOrBetaLocantEl, Atom *anomericAtom, Atom *anomericReferenceAtom);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException"> </exception>
							void detectConjunctiveSuffixGroups(Element *subOrRoot, std::vector<Element*> &allGroups) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException"> </exception>
							void preliminaryProcessSuffixes(Element *group, std::vector<Element*> &suffixes) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							void processSuffixAppliesTo(Element *group, std::vector<Element*> &suffixes, Fragment *suffixableFragment) throw(ComponentGenerationException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							std::vector<Fragment*> resolveGroupAddingSuffixes(std::vector<Element*> &suffixes, Fragment *frag) throw(StructureBuildingException, ComponentGenerationException);
							...
							/// <param name="frag"> The fragment to which the suffix will be applied </param>
							/// <exception cref="ComponentGenerationException"> </exception>
							void processRemovalOfHydroxyGroupsRules(std::vector<Element*> &suffixes, Fragment *frag) throw(ComponentGenerationException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
						public:
							static bool checkLocantPresentOnPotentialRoot(BuildState *state, Element *startingElement, const std::wstring &locant) throw(StructureBuildingException);
							...
							/// <exception cref="ComponentGenerationException">  </exception>
						private:
							void handleGroupIrregularities(std::vector<Element*> &groups) throw(StructureBuildingException, ComponentGenerationException);
							...
							/// @return </param>
							/// <exception cref="ComponentGenerationException"> </exception>
							Element *determineElementsToResolveIntoRingAssembly(Element *multiplier, int ringJoiningLocants, int outAtomCount) throw(ComponentGenerationException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException"> </exception>
							void processPolyCyclicSpiroNomenclature(Element *subOrRoot) throw(ComponentGenerationException, StructureBuildingException);

							void processNonIdenticalPolyCyclicSpiro(Element *polyCyclicSpiroDescriptor) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException"> </exception>
							void processOldMethodPolyCyclicSpiro(std::vector<Element*> &spiroElements) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException"> </exception>
							void processSpiroBiOrTer(Element *polyCyclicSpiroDescriptor, int components) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							/// <exception cref="ComponentGenerationException"> </exception>
							void processDispiroter(Element *polyCyclicSpiroDescriptor) throw(StructureBuildingException, ComponentGenerationException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							/// <exception cref="ComponentGenerationException">  </exception>
							void determineFeaturesToResolveInSingleComponentSpiro(Element *polyCyclicSpiroDescriptor) throw(StructureBuildingException, ComponentGenerationException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							/// <exception cref="ComponentGenerationException">  </exception>
							void resolveFeaturesOntoGroup(std::vector<Element*> &elementsToResolve) throw(StructureBuildingException, ComponentGenerationException);
						...
						private:
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							int calculateOutAtomsToBeAddedFromInlineSuffixes(Element *group, std::vector<Element*> &suffixes) throw(ComponentGenerationException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							/// <exception cref="ComponentGenerationException"> </exception>
							void implicitlyBracketToPreviousSubstituentIfAppropriate(Element *substituent, std::vector<Element*> &brackets) throw(ComponentGenerationException, StructureBuildingException);

							bool implicitBracketWouldPreventAdditiveBonding(Element *elementBeforeSubstituent, Element *elementAftersubstituent);
							...
							void processConjunctiveNomenclature(Element *subOrRoot) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <param name="brackets"> </param>
							/// <exception cref="StructureBuildingException"> </exception>
							void processBiochemicalLinkageDescriptors(std::vector<Element*> &substituents, std::vector<Element*> &brackets) throw(StructureBuildingException);

							bool isSubBracketOrRoot(Element *element);

							void checkAndApplyFirstLocantOfBiochemicalLinkage(Element *substituent, const std::wstring &biochemicalLinkage) throw(StructureBuildingException);
							...
							/// <param name="substituent"> </param>
							/// <param name="brackets"> </param>
							void addImplicitBracketsWhenFirstSubstituentHasTwoMultipliers(Element *substituent, std::vector<Element*> &brackets);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException"> </exception>
							void assignLocantsToMultipliedRootIfPresent(Element *rightMostElement) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <exception cref="ComponentGenerationException"> </exception>
							/// <exception cref="StructureBuildingException">  </exception>
							void assignLocantsAndMultipliers(Element *subOrBracket) throw(ComponentGenerationException, StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							/// <exception cref="ComponentGenerationException"> </exception>
							void processWordLevelMultiplierIfApplicable(Element *word, std::vector<Element*> &roots, int wordCount) throw(StructureBuildingException, ComponentGenerationException);
