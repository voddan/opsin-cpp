...
//						import static uk.ac.cam.ch.wwmm.opsin.XmlDeclarations.*;
						...
						private:
							const std::unordered_map<Fragment*, Set<Bond*>*> fragToInterFragmentBond = new LinkedHashMap<Fragment*, Set<Bond*>*>();
						...
						public:
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							virtual Fragment *buildSMILES(const std::wstring &smiles, const std::wstring &type, const std::wstring &labelMapping) throw(StructureBuildingException);
							...
							/// <returns> The built fragment </returns>
							/// <exception cref="StructureBuildingException"> </exception>
							virtual Fragment *buildSMILES(const std::wstring &smiles, Element *tokenEl, const std::wstring &labelMapping) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							virtual void incorporateFragment(Fragment *childFrag, Atom *fromAtom, Fragment *parentFrag, Atom *toAtom, int bondOrder) throw(StructureBuildingException);
						...
						public:
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							virtual Element *cloneElement(BuildState *state, Element *elementToBeCloned, int primesToAdd) throw(StructureBuildingException);
