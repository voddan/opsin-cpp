...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
							bool isSubstituent1 = WordRule::substituent->toString()->equals(el1->getFirstChildElement(WORDRULE_EL)->getAttributeValue(WORDRULE_ATR));
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
							bool isSubstituent2 = WordRule::substituent->toString()->equals(el2->getFirstChildElement(WORDRULE_EL)->getAttributeValue(WORDRULE_ATR));
