...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class OpsinResult; } } } } } }
			...
			namespace ch
			{
				namespace wwmm
				{
					namespace opsin
					{
						...
						private:
							static Logger *const LOG = Logger::getLogger(NameToStructure::typeid);
...
//JAVA TO C++ CONVERTER WARNING: The following method was originally marked 'synchronized':
						...
						private:
							...
							static void interactiveCmlOutput(InputStream *input, OutputStream *out, NameToStructureConfig *n2sconfig) throw(IOException, XMLStreamException);

							static void interactiveSmilesOutput(InputStream *input, OutputStream *out, NameToStructureConfig *n2sconfig, bool extendedSmiles) throw(IOException);

							static void interactiveInchiOutput(InputStream *input, OutputStream *out, NameToStructureConfig *n2sconfig, InchiType inchiType) throw(std::exception);
						};
