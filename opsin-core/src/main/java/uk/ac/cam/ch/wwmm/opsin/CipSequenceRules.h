...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class AtomWithHistory; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class AtomListCipComparator; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class ListOfAtomListsCipComparator; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class CipComparator; } } } } } }
				...
				namespace wwmm
				{
					namespace opsin
					{
						...
						public:
							...
							/// @return </param>
							/// <exception cref="CipOrderingException">  </exception>
							virtual std::vector<Atom*> getNeighbouringAtomsInCipOrderIgnoringGivenNeighbour(Atom *neighbourToIgnore) throw(CipOrderingException);
						...
						private:
							...
							private:
								...
								int compareNeighboursByCipPriorityRules(std::vector<std::vector<AtomWithHistory*>> &neighbours1, std::vector<std::vector<AtomWithHistory*>> &neighbours2);
								...
								std::vector<std::vector<AtomWithHistory*>> formListsWithSamePriority(std::vector<std::vector<AtomWithHistory*>> &neighbourLists);
							...
							private:
								class ListOfAtomListsCipComparator : public Comparator<std::vector<std::vector<AtomWithHistory*>>>
								{
									...
									virtual int compare(std::vector<std::vector<AtomWithHistory*>> &a, std::vector<std::vector<AtomWithHistory*>> &b);
								};
