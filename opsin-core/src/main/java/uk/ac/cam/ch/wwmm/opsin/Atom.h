...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { template<typename T>class PropertyKey; } } } } } }
...
//ORIGINAL LINE: @SuppressWarnings("rawtypes") private final java.util.Map<PropertyKey, Object> properties = new java.util.HashMap<PropertyKey, Object>();
						...
						public:
							static PropertyKey<Set<Atom*>*> *const AMBIGUOUS_ELEMENT_ASSIGNMENT;
							/// <summary>
