...
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class OutAtom; } } } } } }
namespace uk { namespace ac { namespace cam { namespace ch { namespace wwmm { namespace opsin { class BuildResults; } } } } } }
...
//						import static uk.ac.cam.ch.wwmm.opsin.OpsinTools.*;
						...
						{
						private:
							static Logger *const LOG = Logger::getLogger(StructureBuildingMethods::typeid);
						...
						public:
							...
							/// <param name="word"> </param>
							/// <exception cref="StructureBuildingException"> </exception>
							static void recursivelyResolveUnLocantedFeatures(BuildState *state, Element *word) throw(StructureBuildingException);

							static void resolveRootOrSubstituentLocanted(BuildState *state, Element *subOrRoot) throw(StructureBuildingException);

							static void resolveRootOrSubstituentUnLocanted(BuildState *state, Element *subOrRoot) throw(StructureBuildingException);


						private:
							static void performLocantedSubstitutiveOperations(BuildState *state, Element *subBracketOrRoot) throw(StructureBuildingException);

							static void performUnLocantedSubstitutiveOperations(BuildState *state, Element *subBracketOrRoot) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							static void performPerHalogenoSubstitution(BuildState *state, Fragment *perhalogenFrag, Element *subBracketOrRoot) throw(StructureBuildingException);
							...
							static void performUnlocantedSubstitutiveOperations(BuildState *state, std::vector<Element*> &multipliedElements) throw(StructureBuildingException);
						...
						private:
							...
							/// <exception cref="StructureBuildingException">  </exception>
						public:
							static void applySubtractivePrefix(BuildState *state, Fragment *fragment, ChemEl chemEl, const std::wstring &locant) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							static void applyUnlocantedSubtractivePrefixes(BuildState *state, Fragment *fragment, ChemEl chemEl, int count) throw(StructureBuildingException);

						private:
							static void applyAnhydroPrefix(BuildState *state, Fragment *frag, Element *subtractivePrefix) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							static void addDehydroInducedTripleBonds(std::vector<Atom*> &atomsToFormTripleBondsBetween) throw(StructureBuildingException);
						...
						private:
							static void applyUnlocantedHydro(BuildState *state, Fragment *frag, std::vector<Element*> &hydrogenElements) throw(StructureBuildingException);

							static void unsaturateBonds(BuildState *state, Fragment *frag, std::vector<int> &unsaturationBondOrders) throw(StructureBuildingException);

							static void unsaturateBonds(BuildState *state, Fragment *frag, int bondOrder, int numToUnsaturate) throw(StructureBuildingException);

							static bool isCycloAlkaneSpecialCase(Fragment *frag, int numToUnsaturate, std::vector<Bond*> &bondsThatCouldBeUnsaturated);

							static bool isCycloAlkaneHeteroatomSpecialCase(Fragment *frag, int numHeteroatoms, std::vector<Atom*> &atomsThatCouldBeReplaced);
						...
						private:
							static void applyUnlocantedHeteroatoms(BuildState *state, Fragment *frag, std::vector<Element*> &heteroatoms) throw(StructureBuildingException);

							static void applyIsotopeSpecifications(BuildState *state, Fragment *frag, std::vector<Element*> &isotopeSpecifications, bool applyLocanted) throw(StructureBuildingException);

							static bool casIsotopeAmbiguitySpecialCase(Fragment *frag, std::vector<Atom*> &parentAtomsToApplyTo, int multiplier) throw(StructureBuildingException);

						public:
							static Atom *findAtomForUnlocantedRadical(BuildState *state, Fragment *frag, OutAtom *outAtom) throw(StructureBuildingException);


						private:
							static std::vector<Bond*> findAlternativeBondsToUnSaturate(Fragment *frag, int bondOrder, Collection<Bond*> *bondsToIgnore);
						...
						private:
							static std::vector<Bond*> findBondsToUnSaturate(Fragment *frag, int bondOrder, bool allowAdjacentUnsaturatedBonds, Set<Bond*> *bondsToIgnore);
						...
						private:
							static void performAdditiveOperations(BuildState *state, Element *subBracketOrRoot) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							static void multiplyOutAndAdditivelyBond(BuildState *state, Element *subOrBracket, Fragment *fragToAdditivelyBondTo) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
							static void performMultiplicativeOperations(BuildState *state, Element *group, Element *multipliedParent) throw(StructureBuildingException);

							static void performMultiplicativeOperations(BuildState *state, BuildResults *multiRadicalBR, Element *multipliedParent) throw(StructureBuildingException);
							...
							/// @return </param>
							/// <exception cref="StructureBuildingException"> </exception>
							static std::vector<Atom*> getPossibleAtomsForUnlocantedConnectionToMultipliedRoot(Element *multipliedGroup, int bondOrder, int primesAdded) throw(StructureBuildingException);
							...
							static void joinFragmentsAdditively(BuildState *state, Fragment *fragToBeJoined, Fragment *parentFrag) throw(StructureBuildingException);

							static void joinFragmentsSubstitutively(BuildState *state, Fragment *fragToBeJoined, Atom *atomToJoinTo) throw(StructureBuildingException);
							...
							/// <exception cref="StructureBuildingException"> </exception>
						public:
							static std::vector<Atom*> formEpoxide(BuildState *state, Fragment *bridgingFragment, Atom *atomToJoinTo) throw(StructureBuildingException);
							...
							/// @return </param>
						private:
							static std::vector<Atom*> findAtomsForSubstitution(Element *subOrBracket, int numberOfSubstitutions, int bondOrder);
						...
						public:
							...
							/// <exception cref="StructureBuildingException"> </exception>
						private:
							static Fragment *findFragmentWithLocant(Element *startingElement, const std::wstring &locant) throw(StructureBuildingException);
						...
						public:
							static std::wstring checkForBracketedPrimedLocantSpecialCase(Element *subBracketOrRoot, const std::wstring &locantString);
							...
							/// <exception cref="StructureBuildingException"> </exception>
						private:
							static void checkAndApplySpecialCaseWhereOutAtomsCanBeCombinedOrThrow(Fragment *frag, Element *group) throw(StructureBuildingException);
