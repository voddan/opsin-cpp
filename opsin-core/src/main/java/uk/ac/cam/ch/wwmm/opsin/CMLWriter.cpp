...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
							writer->writeAttribute(L"elementType", atom->getElement()::toString());
							if (atom->getCharge() != 0)
							{
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
							...
							if (atom->getElement() != ChemEl::H)
							{
								...
								if (hydrogenCount == 0)
								{ //prevent adding of implicit hydrogen
...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
							writer->writeAttribute(L"id", std::wstring(L"a") + Integer::toString(bond->getFrom()) + std::wstring(L"_a") + Integer::toString(bond->getTo()));
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
							writer->writeAttribute(L"atomRefs2", std::wstring(L"a") + Integer::toString(bond->getFrom()) + std::wstring(L" a") + Integer::toString(bond->getTo()));
