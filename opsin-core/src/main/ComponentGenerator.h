...
private:
    ...
    /// <exception cref="ComponentGenerationException">  </exception>
    void checkForAmbiguityWithHWring(const std::wstring &firstHeteroAtomSMILES,
    ...
    /// <param name="secondHeteroAtomSMILES"> </param>
    /// <exception cref="ComponentGenerationException">  </exception>
    void checkForAmbiguityWithHeterogenousHydride(const std::wstring &firstHeteroAtomSMILES,
                                                  const std::wstring &secondHeteroAtomSMILES) throw(ComponentGenerationException);
...
private:
    ...
    void
    processUnbracketedAlphaBetaStereochemistry(Element *stereoChemistryElement) throw(ComponentGenerationException);
    ...
    void processSpiroSystem(Element *chainGroup,
    ...
    /// <exception cref="ComponentGenerationException">  </exception>
    boost::optional<int>
    findIndexOfRingOpenings(const std::wstring &smiles, int locant) throw(ComponentGenerationException);
