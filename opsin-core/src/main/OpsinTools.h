...
public:
    ...
    /// @return </param>
    static Element *
    getNextSiblingIgnoringCertainElements(Element *startingEl, std::vector<std::wstring> &elNamesToIgnore);
    ...
    /// @return </param>
    static Element *
    getPreviousSiblingIgnoringCertainElements(Element *startingEl, std::vector<std::wstring> &elNamesToIgnore);
    ...
    getDescendantElementsWithTagName(Element *startingElement, const std::wstring &elementName);
    ...
    /// @return </param>
    static std::vector<Element *>
    getDescendantElementsWithTagNames(Element *startingElement, std::vector<std::wstring> &elementNames);
    ...
    /// @return </param>
    static std::vector<Element *>
    getChildElementsWithTagNames(Element *startingElement, std::vector<std::wstring> &elementNames);
    ...
    /// @return </param>
    static std::vector<Element *>
    getDescendantElementsWithTagNameAndAttribute(Element *startingElement, const std::wstring &elementName,
    ...
    /// @return </param>
    static std::vector<Element *>
    getChildElementsWithTagNameAndAttribute(Element *startingElement, const std::wstring &elementName,
                                            const std::wstring &attributeName, const std::wstring &attributeValue);
