...
void ComponentGeneration_ProcesslocantsTest::testStereochemistryInLocant1() throw(ComponentGenerationException) {
    ...
    assertEquals(XmlDeclarations::STEREOCHEMISTRYBRACKET_TYPE_VAL,
                 stereochemistry->getAttributeValue(XmlDeclarations::TYPE_ATR));
...
void
ComponentGeneration_ProcesslocantsTest::testCarbohydrateStyleLocantsNoNumericComponent() throw(ComponentGenerationException) {
    //tri-O
    locant->setValue(L"O");
    Element *multiplier = new TokenEl(XmlDeclarations::MULTIPLIER_EL);
    Attribute tempVar(XmlDeclarations::VALUE_ATR, L"3");
...
void
ComponentGeneration_ProcesslocantsTest::testCarbohydrateStyleLocantsCounterExample() throw(ComponentGenerationException) {
