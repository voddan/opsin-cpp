...
#include "../../../../../../../../main/java/uk/ac/cam/ch/wwmm/opsin/SMILESWriter.h"
#include "../../../../../../../../main/java/uk/ac/cam/ch/wwmm/opsin/StringTools.h"
...
//ORIGINAL LINE: @Test public void testRingOpeningsGreaterThan10() throws StructureBuildingException
						...
						{
							Fragment *f = fm->buildSMILES(L"C12=C3C4=C5C6=C1C7=C8C9=C1C%10=C%11C(=C29)C3=C2C3=C4C4=C5C5=C9C6=C7C6=C7C8=C1C1=C8C%10=C%10C%11=C2C2=C3C3=C4C4=C5C5=C%11C%12=C(C6=C95)C7=C1C1=C%12C5=C%11C4=C3C3=C5C(=C81)C%10=C23");
							fm->makeHydrogensExplicit();
							std::wstring smiles = SMILESWriter::generateSmiles(f);
							assertEquals(L"C12=C3C4=C5C6=C1C1=C7C8=C9C%10=C%11C(=C28)C3=C3C2=C4C4=C5C5=C8C6=C1C1=C6C7=C9C9=C7C%10=C%10C%11=C3C3=C2C2=C4C4=C5C5=C%11C%12=C(C1=C85)C6=C9C9=C%12C%12=C%11C4=C2C2=C%12C(=C79)C%10=C32", smiles);
						}
...
//ORIGINAL LINE: @Test public void testDoubleBondSupport4() throws StructureBuildingException
						void SMILESWriterTest::testDoubleBondSupport4() throw(StructureBuildingException)
						{
							...
							fm->makeHydrogensExplicit();
							f->findBond(2, 6)->setBondStereoElement(std::vector<Atom*>{f->getAtomByID(1), f->getAtomByID(2), f->getAtomByID(6), f->getAtomByID(7)}, BondStereoValue::TRANS);
							f->findBond(7, 8)->setBondStereoElement(std::vector<Atom*>{f->getAtomByID(12), f->getAtomByID(7), f->getAtomByID(8), f->getAtomByID(9)}, BondStereoValue::TRANS);
							std::wstring smiles = SMILESWriter::generateSmiles(f);
...
//ORIGINAL LINE: @Test public void testDoubleBondSupport7() throws StructureBuildingException
						void SMILESWriterTest::testDoubleBondSupport7() throw(StructureBuildingException)
						{
							...
							fm->makeHydrogensExplicit();
							f->findBond(1, 2)->setBondStereoElement(std::vector<Atom*>{f->getAtomByID(11), f->getAtomByID(1), f->getAtomByID(2), f->getAtomByID(8)}, BondStereoValue::TRANS);
							f->findBond(3, 4)->setBondStereoElement(std::vector<Atom*>{f->getAtomByID(2), f->getAtomByID(3), f->getAtomByID(4), f->getAtomByID(5)}, BondStereoValue::TRANS);
							std::wstring smiles = SMILESWriter::generateSmiles(f);
