...
//ORIGINAL LINE: @Test public void coronene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1cc2ccc3ccc4ccc5ccc6ccc71.c28c3c4c5c6c78", L"1/2/2a/3/4/4a/5/6/6a/7/8/8a/9/10/10a/11/12/12a/12b/12c/12d/12e/12f/12g");
						}
...
//ORIGINAL LINE: @Test public void isoviolanthrene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1cccc2c3ccc4c5ccc6Cc7ccccc7c8ccc9c%10ccc%11Cc12.c3%11c4%10.c59c68", L"1/2/3/4/4a/4b/5/6/6a/6b/7/8/8a/9/9a/10/11/12/13/13a/13b/14/15/15a/15b/16/17/17a/18/18a/18b/18c/18d/18e");
						}
...
//ORIGINAL LINE: @Test @Ignore public void ovalene() throws StructureBuildingException
						void FusedRingNumbererTest::ovalene() throw(StructureBuildingException)
						{ //Transient BUG in path finding code
							compareNumbering(L"c1cc2ccc3ccc4cc5ccc6ccc7ccc8cc91.c19c2c3c4c9c5c6c7c8c19", L"1/2/2a/3/4/4a/5/6/6a/7/7a/8/9/9a/10/11/11a/12/13/13a/14/14a/14b/14c/14d/14e/14f/14g/14h/14i/14j/14k");
						}
...
//ORIGINAL LINE: @Test public void perylene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1ccc2cccc3c4cccc5cccc6c71.c237.c456", L"1/2/3/3a/4/5/6/6a/6b/7/8/9/9a/10/11/12/12a/12b/12c/12d");
						}
...
//ORIGINAL LINE: @Test public void picene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1cccc2ccc3c4ccc5ccccc5c4ccc3c21", L"1/2/3/4/4a/5/6/6a/6b/7/8/8a/9/10/11/12/12a/12b/13/14/14a/14b");
						}
...
//ORIGINAL LINE: @Test public void pyranthrene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1cccc2c3cc4ccc5cc6ccccc6c6cc7ccc8cc12.c38c7c4c56", L"1/2/3/4/4a/4b/5/5a/6/7/7a/8/8a/9/10/11/12/12a/12b/13/13a/14/15/15a/16/16a////");
						}
...
//ORIGINAL LINE: @Test public void rubicene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1ccc2c3ccccc3c3c4cccc5c6ccccc6c6c71.c237.c456", L"1/2/3/3a/3b/4/5/6/7/7a/7b/7c/8/9/10/10a/10b/11/12/13/14/14a/14b/14c/14d/14e");
						}
...
//ORIGINAL LINE: @Test public void violanthrene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1cccc2Cc3ccc4c5ccc6Cc7ccccc7c8ccc9c%10ccc%11c12.c3%11c4%10.c59c68", L"1/2/3/4/4a/5/5a/6/7/7a/7b/8/9/9a/10/10a/11/12/13/14/14a/14b/15/16/16a/16b/17/18/18a/18b////");
						}
...
//ORIGINAL LINE: @Test public void naphthotetraphene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1cc2ccc3ccc4cc5ccccc5cc4c3c2c6ccccc16", L"1/2/2a/3/4/4a/5/6/6a/7/7a/8/9/10/11/11a/12/12a/12b/12c/12d/13/14/15/16/16a");
						}
...
//ORIGINAL LINE: @Test public void anthratetraphene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1cc2ccc3ccc4cc5ccccc5cc4c3c2c6cc7ccccc7cc16", L"1/2/2a/3/4/4a/5/6/6a/7/7a/8/9/10/11/11a/12/12a/12b/12c/12d/13/13a/14/15/16/17/17a/18/18a");
						}
...
//ORIGINAL LINE: @Test public void octalenotetraphene() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1ccc2ccc3ccc4cc5ccccc5cc4c3c2cc6ccccccc16", L"1/2/3/3a/4/5/5a/6/7/7a/8/8a/9/10/11/12/12a/13/13a/13b/13c/14/14a/15/16/17/18/19/20/20a");
						}
...
//ORIGINAL LINE: @Test public void difficultChain() throws StructureBuildingException
						...
						{
							compareNumbering(L"C1C2C3C4CC5CC6CCCCCCC6CCC5CC4CC3C12", L"1/1a/1b/1c/2/2a/3/3a/4/5/6/7/8/9/9a/10/11/11a/12/12a/13/13a/13b");
						}
...
//ORIGINAL LINE: @Test public void difficultChain2() throws StructureBuildingException
						...
						{
							compareNumbering(L"C1C2CCCCC2C3C4C5C6CCC7C8CCCCC8C7CCC56C4CCC13", L"1/1a/2/3/4/5/5a/5b/5c/5d/5e/6/7/7a/7b/8/9/10/11/11a/11b/12/13/13a/13b/14/15/15a");
						}
...
//ORIGINAL LINE: @Test public void anthrazine() throws StructureBuildingException
						...
						{
							compareNumbering(L"c1cccc2cc3c4nc5ccc6cc7ccccc7cc6c5nc4ccc3cc12", L"1/2/3/4/4a/5/5a/5b/6/6a/7/8/8a/9/9a/10/11/12/13/13a/14/14a/14b/15/15a/16/17/17a/18/18a");
						}
...
//ORIGINAL LINE: @Test @Ignore public void tripleSubstituedSevenMembered() throws StructureBuildingException
						...
						void FusedRingNumbererTest::compareNumbering(const std::wstring &smiles, const std::wstring &labels) throw(StructureBuildingException)
						{
							Fragment *fusedRing = sBuilder->build(smiles, mock(Element::typeid), XmlDeclarations::NONE_LABELS_VAL);
