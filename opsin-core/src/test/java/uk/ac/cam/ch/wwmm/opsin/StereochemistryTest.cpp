...
#include "../../../../../../../../main/java/uk/ac/cam/ch/wwmm/opsin/StereoAnalyser.h"
#include "../../../../../../../../main/java/uk/ac/cam/ch/wwmm/opsin/Atom.h"
#include "../../../../../../../../main/java/uk/ac/cam/ch/wwmm/opsin/ChemEl.h"
#include "../../../../../../../../main/java/uk/ac/cam/ch/wwmm/opsin/CipOrderingException.h"
...
#include "../../../../../../../../main/java/uk/ac/cam/ch/wwmm/opsin/CipSequenceRules.h"
#include "../../../../../../../../main/java/uk/ac/cam/ch/wwmm/opsin/StereochemistryHandler.h"
...
//ORIGINAL LINE: @Test public void testCIPpriority7() throws StructureBuildingException
						...
						{
							Fragment *f = fm->buildSMILES(L"[H]OC2([H])(C([H])([H])C([H])([H])C3([H])(C4([H])(C([H])([H])C([H])([H])C1=C([H])C([H])([H])C([H])([H])C([H])([H])C1([H])C4([H])(C([H])([H])C([H])([H])C23(C([H])([H])[H])))))");
...
//ORIGINAL LINE: @Test public void testCIPpriority8() throws StructureBuildingException
						...
						{
							Fragment *f = n2s->parseChemicalName(L"(6aR)-6-phenyl-6,6a-dihydroisoindolo[2,1-a]quinazoline-5,11-dione")->getStructure();
...
//ORIGINAL LINE: @Test public void testCIPpriority10() throws StructureBuildingException
						...
						{
							Fragment *f = fm->buildSMILES(L"C(O[H])([H])(C1([H])C([H])(F)C([H])(Cl)C([H])([H])C([H])(I)C1([H])([H]))C1([H])C([H])(F)C([H])(Br)C([H])([H])C([H])(Cl)C1([H])([H])");
							fm->makeHydrogensExplicit();
							CipSequenceRules tempVar(f->getFirstAtom());
							std::vector<Atom*> cipOrdered = (&tempVar)->getNeighbouringAtomsInCipOrder();
							for (int i = 0; i < cipOrdered.size(); i++)
...
//ORIGINAL LINE: @Test public void testAtomParityEquivalence1()
						...
						{
							Atom *a1 = new Atom(1, ChemEl::C, mock(Fragment::typeid));
							Atom *a2 = new Atom(2, ChemEl::C, mock(Fragment::typeid));
							Atom *a3 = new Atom(3, ChemEl::C, mock(Fragment::typeid));
							Atom *a4 = new Atom(4, ChemEl::C, mock(Fragment::typeid));
...
//ORIGINAL LINE: @Test public void testChiralAtomWhichBecomesAchiral() throws StructureBuildingException
						void StereochemistryTest::testChiralAtomWhichBecomesAchiral() throw(StructureBuildingException)
						{
							...
							assertNull(L"This atom is no longer a chiral centre and hence should not have an associated atom parity", formerChiralCentre->getAtomParity());
						}
...
//ORIGINAL LINE: @Test public void testChiralBondWhichBecomesAchiral() throws StructureBuildingException
						void StereochemistryTest::testChiralBondWhichBecomesAchiral() throw(StructureBuildingException)
						{
							...
							assertNull(L"This Bond is no longer a chiral centre and hence should not have an associated bond stereo", formerChiralBond->getBondStereo());
						}
...
//ORIGINAL LINE: @Test public void testIsTetrahedral() throws StructureBuildingException
						...
						{
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"C(N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[Si](N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[Ge](N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[N+](N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[P+](N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[As+](N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[B-](N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[Sn](N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[N](=N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[P](=N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[S](=N)(=O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[S+](=N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[S](=O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[S+](O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"N1(C)(OS1)")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[Se](=N)(=O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[Se+](=N)(O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[Se](=O)(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isKnownPotentiallyStereogenic(fm->buildSMILES(L"[Se+](O)(Cl)Br")->getFirstAtom()));
						}
...
//ORIGINAL LINE: @Test public void testAchiralDueToResonance() throws StructureBuildingException
						...
						{
							assertEquals(true, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"[S](=N)(=O)([O-])Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"[S](=O)([O-])Br")->getFirstAtom()));
							assertEquals(false, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"[S](=S)([O-])Br")->getFirstAtom()));
							assertEquals(false, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"C(N)([O-])(Cl)Br")->getFirstAtom()));
						}
...
//ORIGINAL LINE: @Test public void testAchiralDueToTautomerism() throws StructureBuildingException
						...
						{
							assertEquals(true, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"[S](=N)(=O)([OH])Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"[S](=O)([OH])Br")->getFirstAtom()));
							assertEquals(false, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"[S](=S)([OH])Br")->getFirstAtom()));
							assertEquals(false, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"C(N)([OH])(Cl)Br")->getFirstAtom()));
							assertEquals(true, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"N([H])(CC)(C)")->getFirstAtom()));
							assertEquals(false, StereoAnalyser::isAchiralDueToResonanceOrTautomerism(fm->buildSMILES(L"N1(C)(OS1)")->getFirstAtom()));
						}
