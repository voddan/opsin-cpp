...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
								JniInchiAtom tempVar(0.0, 0.0, 0.0, atom->getElement()::toString());
							...
							{
								JniInchiBond tempVar2(opsinIdAtomMap[bond->getFrom()], opsinIdAtomMap[bond->getTo()], INCHI_BOND_TYPE::getValue(bond->getOrder()));
							...
							{ //add atomParities
								...
								if (atomParity != nullptr)
								{
									...
									input->addStereo0D(JniInchiStereo0D::createNewTetrahedralStereo0D(opsinIdAtomMap[atom->getID()], opsinIdAtomMap[atomRefs4AsInt[0]], opsinIdAtomMap[atomRefs4AsInt[1]], opsinIdAtomMap[atomRefs4AsInt[2]], opsinIdAtomMap[atomRefs4AsInt[3]], parity));
								}
							}
							...
							{ //add bondStereos
								...
								if (bondStereo != nullptr)
								{
									...
									{
										input->addStereo0D(JniInchiStereo0D::createNewDoublebondStereo0D(opsinIdAtomMap[atomRefs4Ids[0]], opsinIdAtomMap[atomRefs4Ids[1]], opsinIdAtomMap[atomRefs4Ids[2]], opsinIdAtomMap[atomRefs4Ids[3]], INCHI_PARITY::ODD));
									}
									else if (BondStereoValue::TRANS::equals(bondStereo->getBondStereoValue()))
									{
										input->addStereo0D(JniInchiStereo0D::createNewDoublebondStereo0D(opsinIdAtomMap[atomRefs4Ids[0]], opsinIdAtomMap[atomRefs4Ids[1]], opsinIdAtomMap[atomRefs4Ids[2]], opsinIdAtomMap[atomRefs4Ids[3]], INCHI_PARITY::EVEN));
									}
								}
							}
